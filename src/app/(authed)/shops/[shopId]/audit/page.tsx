  ...
  return (
    <div style={{ display: "grid", gap: 22 }}>
      <PageHeader
        eyebrow="Activity"
        title="Shop Activity"
        description="Show recent events clearly so an admin can understand what changed without reading raw audit payloads."
        actions={<ActionLink href="/audit" tone="primary">Open Full Activity Feed</ActionLink>}
      />
      ...
      {status ? (
        ...
        <SectionBlock title="Activity" description="Loading recent shop activity...">
          <div style={{ opacity: 0.76 }}>Loading...</div>
        </SectionBlock>
      ) : rows.length === 0 ? (
