export const theme = {
  ...
  shadow: {
    ...
    raised: "0 22px 52px rgba(0,0,0,0.30)",
    healthy: "0 18px 42px rgba(14, 45, 34, 0.16)",
    warning: "0 20px 44px rgba(72, 42, 8, 0.18)",
    critical: "0 20px 48px rgba(74, 10, 14, 0.20)",
    hero: "0 26px 68px rgba(0,0,0,0.38)",
    glowSoft:
      "0 0 0 1px rgba(123,157,214,0.06), 0 18px 36px rgba(0,0,0,0.20)",
    nav: "0 24px 60px rgba(4,7,16,0.46)",
    button: "0 14px 28px rgba(8,15,30,0.28)",
  },
} as const;
